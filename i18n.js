...
(function (global) {
    ...
    const translations = {
        en: {
            ...
            ld_input_label: 'Input:',
            ld_numpad_aria: 'Number pad',
            ld_backspace_aria: 'Delete',
            ld_enter_aria: 'Confirm input',
        ...
        es: {
            ...
            ld_input_label: 'Entrada:',
            ld_numpad_aria: 'Teclado numérico',
            ld_backspace_aria: 'Borrar',
            ld_enter_aria: 'Confirmar la entrada',
        ...
        ru: {
            ...
            ld_backspace_aria: 'Стереть',
            ld_enter_aria: 'Подтвердить ввод',
